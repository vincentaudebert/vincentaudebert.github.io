...
Instead of having to add this annoying header to your GET request `Authorization: Bearer [yourtoken]`, the easiest way is just to add your access token directly in your url as a parameter.
